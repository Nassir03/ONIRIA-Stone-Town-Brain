...
Each room note must connect to:
...
The following must be verified from drawings, LiDAR scans, site inspection, or supplier manuals:

- Exact dimensions
- Final FF&E list
- Final electrical points
- Final plumbing points
- KNX device model and channel mapping
- Wi-Fi access point placement
- Speaker placement
- Sensor placement
- Smart-lock model
- AC model and capacity
