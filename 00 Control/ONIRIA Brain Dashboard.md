...
- **Working target opening:** 21 December 2026
- **Hard deadline:** April 2027
- **Current phase:** Construction / MEP coordination / interior implementation / procurement

## Critical pre-opening focus

1. Make every room and system machine-readable.
2. Lock wired-in KNX, lighting, network, audio, sensor and access decisions before closure.
...
A new team must be able to understand **what is true, where the evidence is, what remains unknown, who owns the next action, and how the hotel operates** without relying on memory outside this Brain.
